<template>
  <div class="wrapper">
    ...
    <h1 class="text-h3 text-center font-weight-bold">Samsung</h1>

    <br />
    <br />

    <!-- Image de couverture pour la catégorie iPhone -->
    ...
    <v-card class="mx-auto pa-5 rounded-xl" elevation="0" v-for="item in samsung" :key="item.id">
      ...
      <v-card-actions>
        <v-btn color="primary" @click="() => { addSound(); addItemToCart(item); }">Ajouter</v-btn>
      </v-card-actions>
    </v-card>
