<template>
  <div class="wrapper">
    ...
    <h1 class="text-h3 text-center font-weight-bold">Redmi</h1>
    ...
    <v-card class="mx-auto pa-5 rounded-xl" elevation="0" v-for="item in redmi" :key="item.id">
...
export default {
  data() {
    return {
      // Nous récupérons les redmi depuis la structure des données
      redmi: telephones.redmi
    };
  },
  methods: {
