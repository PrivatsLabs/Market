<template>
  <div class="slider">
    <!-- Boucle uniquement sur les téléphones Samsung -->
    <div v-for="item in telephones.samsung" :key="item.id" class="card">
      <div class="img-box">
      ...
      <div class="info-box">
        ...
        <p>
          A partir de <span>{{ item.prix }}</span> FCFA
        </p>
      </div>
      <br /><br />
...
import { telephones } from "../utils/data"; // Importer les téléphones par catégories
...
vibrate() {
  ...
  data() {
    return {
      telephones, // Téléphones classés par catégories, avec Samsung inclus
    };
  },
};
</script>
